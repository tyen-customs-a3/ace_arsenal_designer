...
class CfgWeapons
{
	...
	class CUP_sgun_SPAS12: Rifle_Base_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"\CUP\Weapons\CUP_Weapons_SPAS12\data\anim\spas_hand.rtm"
		};
		inertia=0.5;
		...
		reloadMagazineSound[]=
		{
			"CUP\Weapons\CUP_Weapons_SPAS12\data\sfx\Reload",
			1,
			1,
			35
		};
		drySound[]=
		{
			"CUP\Weapons\CUP_Weapons_SPAS12\data\sfx\Dry",
			1,
			1,
			35
		};
		...
		descriptionShort="$STR_CUP_dss_spas12";
